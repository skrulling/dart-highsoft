    ...
    <div className="max-w-2xl mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="font-medium">Players <span className="text-sm text-muted-foreground">(min 3)</span></div>
        ...
        <div className="flex gap-2">
          <Input className="flex-1" placeholder="New player name" value={newPlayerName} onChange={(e) => setNewPlayerName(e.target.value)} />
