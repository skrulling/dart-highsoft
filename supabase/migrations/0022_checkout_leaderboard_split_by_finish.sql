-- Split checkout leaderboard by finish rule (single out vs double out) while keeping the latest dart-count logic
...
CREATE OR REPLACE VIEW public.checkout_leaderboard_single_out AS
...
CREATE OR REPLACE VIEW public.checkout_leaderboard_double_out AS
SELECT turn_id, player_id, display_name, score, darts_used, date
FROM public.checkout_leaderboard
