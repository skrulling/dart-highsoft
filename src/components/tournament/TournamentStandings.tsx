...
import type { TournamentPlayerRecord, TournamentStatus } from '@/lib/tournament/types';
...
export function TournamentStandings({ players, winnerId, tournamentStatus }: Props) {
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-1">
          {sorted.map((p) => {
            const isUnfinished = tournamentStatus === 'cancelled' && p.final_rank === null;
